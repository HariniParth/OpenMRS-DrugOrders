            ...
            <div id="medPlansForDisease">
                <% existingMedplans.each { existingMedplan -> %>
                    <div id="itemSpace" class="fields">
                        ...
                        <span id="button">
                            <i class="icon-trash delete-action right" title="${ ui.message("Discontinue") }" onclick="deleteMedPlanItem('${existingMedplan.id}','${existingMedplan.diseaseId.getDisplayString()}','${existingMedplan.drugId.getDisplayString()}','${existingMedplan.dose}','${existingMedplan.doseUnits.getDisplayString()}','${existingMedplan.route.getDisplayString()}','${existingMedplan.quantity}','${existingMedplan.quantityUnits.getDisplayString()}','${existingMedplan.duration}','${existingMedplan.durationUnits.getDisplayString()}','${existingMedplan.frequency}')"></i>
