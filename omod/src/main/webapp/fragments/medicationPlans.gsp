                                ...
                                <% if((ActivePlanExtension.get(drugOrderMain.key).get(drugOrderMn.key).orderstatus).equals("Active-Plan")) { %>
                                    ...
                                    <div class="detailsLink">
                                        ...
                                        <div id="button" class="pull-right">
                                            ...
                                            <% if(ActivePlanExtension.get(drugOrderMain.key).get(drugOrderMn.key).onHold == 1) { %>
                                                <span class="holdComments" title="${ ui.message(ActivePlanExtension.get(drugOrderMain.key).get(drugOrderMn.key).comments) }">Hold</span>
                                            <% } else { %>
