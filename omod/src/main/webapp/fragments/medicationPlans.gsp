                        ...
                        <td class="fields">
                            ...
                            <div class="orderDetails">
                                <% drugOrderMain.value.each { drugOrderMn -> %>
                                    ...
                                    <div class="detailsLink <% if(ActivePlanExtension.get(drugOrderMain.key).get(drugOrderMn.key).fordiscard == 1) { %> discontinued <% } %> <% if(ActivePlanExtension.get(drugOrderMain.key).get(drugOrderMn.key).onhold == 1) { %> onhold <% } %>" title="${ ui.message(ActivePlanExtension.get(drugOrderMain.key).get(drugOrderMn.key).comments) }">
