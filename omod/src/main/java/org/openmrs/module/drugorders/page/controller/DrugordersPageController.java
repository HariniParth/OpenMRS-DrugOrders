...
public class DrugordersPageController {
            ...
            try {
                if ("addOrderDraft".equals(action)) {
                    ...
                    if (!(drugNameEntered.equals("")) && !(drugRoute.equals("")) && !(drugDose.equals("")) && !(drugDoseUnits.equals("")) && !(drugQuantity.equals("")) && !(quantityUnits.equals("")) && !(drugFrequency.equals("")) && (drugDuration != null) && !(durationUnits.equals(""))) {
                        ...
                        int order = createNewDrugOrder(drugOrder, patient, drugNameEntered, drugRoute, drugDose, drugDoseUnits, drugQuantity, quantityUnits, drugFrequency, drugDuration, durationUnits, "create", orderID);
                ...
                if ("editDrugOrder".equals(action)) {
                    ...
                    int order = createNewDrugOrder(drugorderMainEdited, patient, drugName, editDrugRoute, editDrugDose, editDrugDoseUnits, editDrugQuantity, editQuantityUnits, editDrugFrequency, editDrugDuration, editDurationUnits, "edit", orderID);
                ...
                if ("renewDrugOrder".equals(action)) {
                    ...
                    int order = createNewDrugOrder(drugorderMainRenewed, patient, drugName, renewDrugRoute, renewDrugDose, renewDrugDoseUnits, renewDrugQuantity, renewQuantityUnits, renewDrugFrequency, renewDrugDuration, renewDurationUnits, "renew", orderID);
    ...
    private int createNewDrugOrder(DrugOrder order, Patient patient, String drugNameConfirmed, String drugRoute,
            ...
            String drugFrequency, Integer drugDuration, String durationUnits, String action, String draftOrderID) {
        ...
        if (action.equals("renew") || action.equals("edit")) {
            ...
            int i;
            if (!(draftOrderID).equals("")) {
                i = Integer.valueOf(draftOrderID);
            } else {
                i = ConfirmOrderFragmentController.getCurrentDraftOrderIndex();
            }
